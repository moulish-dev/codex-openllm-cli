...
/**
 * Stubbed model utility file for Ollama support only.
 *
 * You can later expand this to support dynamic detection of Ollama models
 * (e.g., calling `http://localhost:11434/api/tags`).
 */
...
// Always return true since we're not calling OpenAI /models
export async function isModelSupportedForResponses(
  model: string | undefined | null,
): Promise<boolean> {
  return true;
